  ...
  render(){
    return(
      <View style={{flex:1, borderWidth:2}}>
        ...
        />
         <h4> click on the link for "a" words other words anre not written here but you can search other words too <a href = "https://drive.google.com/file/d/1X0mDLBhNzIcRmlAvlaf6yyXCg6OOi3TO/view?usp=sharing">click here </a></h4>
